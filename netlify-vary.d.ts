...
export type StartRuleNames = "Netlify_Vary";
export interface ParseOptions<T extends StartRuleNames = "Netlify_Vary"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Netlify_Vary">>(
  input: string,
  options?: Options,
): any;
